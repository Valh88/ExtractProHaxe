...
".chip-ready { background:#C8956C; }",
".chip-waiting { background:#3A2A18; }",
".chip-notready { background:#3A2A18; }",
".chip-bg { position:absolute; width:68; height:100; background:#1A1208; }",
".chip-frame { position:absolute; width:48; height:48; }",
".chip-ready .chip-frame { background:#C8956C; }",
